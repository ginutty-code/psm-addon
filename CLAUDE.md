...
≥2 for errors; the project carries a stable warning baseline (64), so failing on any
...
The current clean baseline is **64 warnings / 0 errors**. Treat any change in it as
